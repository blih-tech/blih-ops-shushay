...
export function EcosystemCanvas() {
  ...
  return (
    <div ref={containerRef} className="bg-[#EEF3FF]/40 border border-[#D9CEDF] rounded-3xl p-8 sm:p-12 space-y-12 relative overflow-hidden select-none font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative z-10">
        <div className="space-y-3 lg:col-span-8">
          ...
          <h2 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-[#17131F] leading-tight">
            Evidence becomes<br />professional identity.
          </h2>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center pt-4 relative min-h-[500px]">
        ...
        <div className="lg:col-span-3 flex flex-col gap-4">
          ...
          <div
            ...
            style={{ opacity: 0 }}
          >
            <h4 className="font-display text-base font-bold text-[#17131F] mb-1">Course completed</h4>
            <span className="font-mono text-[9px] text-[#6E6678] uppercase tracking-wider">learning evidence</span>
          </div>
          ...
          <div
            ...
            style={{ opacity: 0 }}
          >
            <h4 className="font-display text-base font-bold text-[#17131F] mb-1">Assessment passed</h4>
            <span className="font-mono text-[9px] text-[#6E6678] uppercase tracking-wider">learning evidence</span>
          </div>
          ...
          <div
            ...
            style={{ opacity: 0 }}
          >
            <h4 className="font-display text-base font-bold text-[#1E5BFF] mb-1">React skill verified</h4>
            <span className="font-mono text-[9px] text-[#6E6678] uppercase tracking-wider">skill proof</span>
          </div>
        </div>
          ...
          <div className="w-full max-w-[470px] bg-white border border-[#D9CEDF] rounded-[34px] p-8 shadow-[0_28px_58px_rgba(23,19,31,0.08)] space-y-8 relative">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-[#17131F] w-[100px] shrink-0">React</span>
                <div className="flex-1 bg-[#E8E0EF] h-2 rounded-full overflow-hidden relative mx-4">
                  <div className="bg-[#1E5BFF] h-full rounded-full profile-progress-fill" data-width="89.5%" />
                </div>
                <div className="w-[70px] text-right leading-tight font-mono text-[10px] text-[#1E5BFF]">
                  <span className="font-display text-base font-bold block">94</span>
                  <span>Verified</span>
                </div>
              </div>
              ...
              {/* TypeScript */}
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-[#17131F] w-[100px] shrink-0">TypeScript</span>
                <div className="flex-1 bg-[#E8E0EF] h-2 rounded-full overflow-hidden relative mx-4">
                  <div className="bg-[#1E5BFF] h-full rounded-full profile-progress-fill" data-width="84.7%" />
                </div>
                <div className="w-[70px] text-right leading-tight font-mono text-[10px] text-[#1E5BFF]">
                  <span className="font-display text-base font-bold block">89</span>
                  <span>Verified</span>
                </div>
              </div>
              ...
              {/* Accessibility */}
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-[#17131F] w-[100px] shrink-0">Accessibility</span>
                <div className="flex-1 bg-[#E8E0EF] h-2 rounded-full overflow-hidden relative mx-4">
                  <div className="bg-[#FF8A5B] h-full rounded-full profile-progress-fill" data-width="78%" />
                </div>
                <div className="w-[70px] text-right leading-tight font-mono text-[10px] text-[#6E6678]">
                  <span className="font-display text-base font-bold block">82</span>
            ...
            <div className="grid grid-cols-3 gap-2.5 pt-6 border-t border-[#D9CEDF]/60">
              <div className="bg-[#DDE7FF] rounded-[18px] p-3 text-center flex flex-col justify-center items-center h-[70px]">
                <span className="font-display text-2xl font-bold text-[#1E5BFF] block leading-none">4</span>
                <span className="font-mono text-[9px] text-[#6E6678] mt-1 leading-tight uppercase font-medium">verified assessments</span>
              </div>
              <div className="bg-[#F7F9FF] rounded-[18px] p-3 text-center flex flex-col justify-center items-center h-[70px] border border-[#D9CEDF]/40">
                <span className="font-display text-2xl font-bold text-[#1E5BFF] block leading-none">12</span>
                <span className="font-mono text-[9px] text-[#6E6678] mt-1 leading-tight uppercase font-medium">completed projects</span>
              </div>
              <div className="bg-[#F7F9FF] rounded-[18px] p-3 text-center flex flex-col justify-center items-center h-[70px] border border-[#D9CEDF]/40">
                <span className="font-display text-2xl font-bold text-[#1E5BFF] block leading-none">17</span>
                <span className="font-mono text-[9px] text-[#6E6678] mt-1 leading-tight uppercase font-medium">client reviews</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-3 flex flex-col gap-4">
          ...
          <div
            ...
            style={{ opacity: 0 }}
          >
            <h4 className="font-display text-base font-bold text-[#17131F] mb-1">Real project completed</h4>
            <span className="font-mono text-[9px] text-[#6E6678] uppercase tracking-wider">skill proof</span>
          </div>
          ...
          <div
            ...
            style={{ opacity: 0 }}
          >
            <h4 className="font-display text-base font-bold text-[#17131F] mb-1">Client review received</h4>
            <span className="font-mono text-[9px] text-[#6E6678] uppercase tracking-wider">work reputation</span>
          </div>
          ...
          <div
            ...
            style={{ opacity: 0 }}
          >
            <h4 className="font-display text-base font-bold text-[#17131F] mb-1">Reputation increased</h4>
            <span className="font-mono text-[9px] text-[#6E6678] uppercase tracking-wider">work reputation</span>
          </div>
        </div>
      </div>
      ...
      <div className="text-center pt-6 relative z-10">
        <span className="font-mono text-[11px] text-[#6E6678] bg-[#EEF3FF] border border-[#D9CEDF]/60 rounded-full px-4 py-1.5 inline-block uppercase tracking-wider">
          Scroll behavior: evidence objects move into the profile and become skill confidence, verified proof and reputation.
        </span>
      </div>
    </div>
  );
