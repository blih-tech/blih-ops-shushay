    ...
    <div ref={containerRef} className="min-h-screen bg-white text-[#17131F] font-sans selection:bg-[#DDE7FF]">
      ...
      <div className="border-b border-[#E6EAF3] py-4 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <Link href="/company/talents" className="flex items-center gap-2 text-sm font-semibold text-[#1E5BFF] hover:underline cursor-pointer">
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="h-[118px] w-[118px] rounded-full border border-[#BFD0FF] bg-[#EEF3FF] flex items-center justify-center overflow-hidden shrink-0 relative">
                <span className="font-display font-bold text-[34px] text-[#1E5BFF]">
                  {talent.name.split(" ").map(w => w[0]).join("").toUpperCase().slice(0, 2)}
                </span>
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-col gap-y-1.5 text-sm text-[#6E6678] pt-2 font-mono">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[#17131F] font-semibold">{talent.name.toLowerCase().replace(" ", ".")}@blih.org</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className="text-[#1E5BFF] font-sans font-semibold w-16">Phone:</span>
                    <span className="text-[#17131F] font-semibold">+251 912 345 678</span>
                  </div>
                  {talent.location && (
                    <div className="flex items-center gap-1.5">
                      <span className="text-[#1E5BFF] font-sans font-semibold w-16">Location:</span>
                      <span className="text-[#17131F] font-semibold">{talent.location}</span>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="divide-y divide-[#E6EAF3] border-t border-b border-[#E6EAF3]">
            <div className="py-6 space-y-2.5">
              ...
              <p className="text-sm text-[#6E6678] leading-relaxed max-w-3xl pt-1">
                Designed and engineered key enterprise application flows, operational dashboards, and database schemas.
              </p>
            </div>
          </div>
        </section>
