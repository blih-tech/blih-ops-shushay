          ...
          <Card className={`border rounded-3xl p-8 bg-white flex flex-col justify-between transition-all ${
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <h3 className="font-display text-2xl font-bold text-[#17131F]">Monthly Hiring Pass</h3>
                <p className="text-xs text-[#6E6678]">Month-to-month access to candidate directory.</p>
              </div>

              <div className="flex items-baseline gap-2">
                <span className="font-display text-4xl sm:text-5xl font-bold text-[#17131F]">2,000</span>
                <span className="font-mono text-sm text-[#6E6678]">ETB / month</span>
              </div>

              <div className="space-y-3 pt-4 border-t border-[#D9CEDF]/70">
                {perks.slice(0, 4).map((perk, pi) => (
                  <div key={pi} className="flex items-start gap-2.5 text-xs text-[#17131F] font-sans">
          ...
          <Card className={`border rounded-3xl p-8 bg-white flex flex-col justify-between transition-all ${
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <h3 className="font-display text-2xl font-bold text-[#17131F]">Annual Enterprise License</h3>
                <p className="text-xs text-[#6E6678]">Full unmetered 12-month access with priority support.</p>
              </div>

              <div className="flex items-baseline gap-2">
                <span className="font-display text-4xl sm:text-5xl font-bold text-[#17131F]">10,000</span>
                <span className="font-mono text-sm text-[#6E6678]">ETB / year</span>
              </div>
