          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm">
              <div>
                ...
                <p className="font-mono text-xs text-[#17131F] break-all mt-1">{subscription.id}</p>
              </div>
              <div>
                <p className="font-mono text-xs text-[#6E6678] uppercase">Auto Renew</p>
                <p className="font-medium text-[#17131F] mt-1">
                  {subscription.autoRenew ? "Enabled" : "Disabled"}
                </p>
              </div>
              <div>
                <p className="font-mono text-xs text-[#6E6678] uppercase">Created Date</p>
                <p className="font-medium text-[#17131F] mt-1">
          ...
          <div className="pt-8 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm">
              ...
              <div>
                ...
                <p className="font-medium text-[#17131F] mt-1">{subscription.companyProfile?.user?.email || "—"}</p>
              </div>
              <div>
                <p className="font-mono text-xs text-[#6E6678] uppercase">Location</p>
                <p className="font-medium text-[#17131F] mt-1">
                  {[subscription.companyProfile?.city, subscription.companyProfile?.country].filter(Boolean).join(", ") || "—"}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="pt-8 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm">
                <div>
                  ...
                  <p className="font-mono text-xs text-[#17131F] break-all mt-1">{subscription.payment.txRef}</p>
                </div>
                <div>
                  <p className="font-mono text-xs text-[#6E6678] uppercase">Payment Status</p>
                  <div className="mt-1">
                    <AdminStatusBadge type="payment" value={subscription.payment.status} />
                  </div>
                </div>
                <div>
                  <p className="font-mono text-xs text-[#6E6678] uppercase">Amount Charged</p>
                  <p className="font-medium text-[#17131F] mt-1">
                    {subscription.payment.amount} {subscription.payment.currency}
                  </p>
                </div>
              </div>
            </div>
